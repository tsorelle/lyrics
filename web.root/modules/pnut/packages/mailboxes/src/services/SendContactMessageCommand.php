...
class SendContactMessageCommand extends TServiceCommand
{
    ...
    protected function run()
    {
        ...
        $body =  ($contentType == TContentType::Html) ?
            sprintf('<p>%s<br><a href="mailto:%s">%s (%s)</a><hr><p>%s<p>',
        ...
        TPostOffice::SendMessageToUs($fromAddress,$message->subject,$body,$contentType,
